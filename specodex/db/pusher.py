...
Examples:
  ...
  uv run specodex/pusher.py --file powersmart.json

  # Push to custom table
  uv run specodex/pusher.py --file powersmart.json --table my-table

  # Use individual writes instead of batch
  uv run specodex/pusher.py --file powersmart.json --no-batch
