...
| 4 | [INTEGRATION.md](INTEGRATION.md) | 🚧 phases A+B ✅ shipped 2026-04-26; BOM copy + "looks complete" badge ✅ shipped 2026-04-30; ChainReviewModal still pending | 🟢 small | Motion-system builder — drive → motor → gearhead. Remaining slice: chain-review modal (~2h, UI-only). |
