...
| 6 | [FRONTEND_TESTING.md](FRONTEND_TESTING.md) | 🚧 Phases 1+2 ✅ shipped 2026-04-30 (per-key persistence + AppContext setter contract); Phases 3–8 pending | 🟢 small (half-day, 8 phases) | Lock down "simple but crucial" frontend state — persistence keys, AppContext setters, ProductList type-switch resets, header toggles, FilterChip unit propagation. Catches L1–L12 spillover bestiary. |
