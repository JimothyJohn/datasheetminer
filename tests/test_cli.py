"""
Tests for the specodex CLI functionality.
...
from specodex.__main__ import main, format_response, validate_url, validate_api_key
...
class TestCLIValidation:
    ...
    def test_validate_api_key_valid(self) -> None:
        ...
        result = validate_api_key(
            ctx, param, "AIzaSyC1234567890abcdefghijklmnopqrstuvwxyz"
        )
...
class TestCLIExecution:
    ...
    def mock_analyze_document(self) -> Generator[MagicMock, None, None]:
        ...
        with patch("specodex.__main__.analyze_document") as mock:
    ...
    def test_cli_version(self, runner: CliRunner) -> None:
        ...
        assert result.exit_code == 0
        assert "specodex, version 0.1.0" in result.output
    ...
    def test_cli_missing_api_key(self, runner: CliRunner) -> None:
        ...
        with patch("specodex.__main__.analyze_document"):
    ...
    def test_cli_basic_execution(
        self, runner: CliRunner, mock_analyze_document: MagicMock
    ) -> None:
